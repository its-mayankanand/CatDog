...
@router.post("/breeds", response_model=schemas.BreedOut, status_code=status.HTTP_201_CREATED)
...
def update_breed(breed_name: str, payload: schemas.BreedUpdate, db: Session = Depends(db.get_db)):
